    ...
    while (run) {
      ...
      switch (choice) {
        ...
        case 2:
          ...
          i2.insertNewUser(email, name, surname); //implementováno
          break;
        case 3:
          SelectQueries se = new SelectQueries();
          // doplòtì tuto metodu dle zadání v metodì    ****doplneno
        ...
        case 5:
          ...
          // doplòte tuto metodu, tak abyste tomuto uživateli zvýšili plat o 20%    ****doplneno
        ...
        case 6:
          ...
          if (s.testIfUserExists(userName)) {
            ...
            // doplòte metodu na vymazání uživatele dle emailu        *****doplneno
        ...
        case 8:
          run = false;
          DBConnection.closeConnection(); //ukonceni bìhu
          break;
        default:
          run = false;
